 ...
 * var validator = recaptcha('my_site_key');
 * ```
 *
 * @class Recaptcha
 */
...
* @api public
*/
var Recaptcha = exports.Recaptcha = function Recaptcha(site_key, secret) {
  this.site_key = secret ? null : site_key;
 ...
 * @api public
 */
Recaptcha.prototype.validate = function(response, remoteip, callback) {
  return new Promise(function(resolve, reject) {
    if (typeof(remoteip) === 'undefined' || typeof(response) === 'undefined') {
